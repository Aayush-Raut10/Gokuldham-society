        ...
        <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li><Link href="#" className="hover:text-white transition">Pay Bills</Link></li>
                            <li><Link href="#" className="hover:text-white transition">Book Amenities</Link></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Link href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} Gokuldham Society. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
